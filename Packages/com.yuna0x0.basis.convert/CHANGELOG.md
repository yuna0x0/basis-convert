...
- Menu toggles are rebuilt as HVR Vixxy controls with menu items, covering both object switching
  and blendshapes, including toggles that only set blendshapes. Toggles driving material
  properties or animating over time are reported rather than half built.
